...
export default function UniformesRH({ aoVoltar, abrirPessoa }) {
  ...
  const colunas = [
    ...
    { chave: 'camisa', rotulo: 'Camisa', ordenavel: true, filtro: 'texto',
      valor: (l) => ouTraco(l.camisa) },
    { chave: 'calca', rotulo: 'Calça', ordenavel: true, filtro: 'texto',
      valor: (l) => ouTraco(l.calca) },
    { chave: 'calcado', rotulo: 'Calçado', ordenavel: true, filtro: 'texto',
