...
function Lista({ somenteMinhas }) {
  ...
  const colunas = [
    { chave: 'colaborador', rotulo: 'Colaborador', ordenavel: true, filtro: 'texto',
      sempreVisivel: true },
    { chave: 'cargo', rotulo: 'Cargo', filtro: 'lista', quebra: true, oculta: true },
    { chave: 'posto', rotulo: 'Posto', filtro: 'lista', quebra: true },
    ...
    { chave: 'avaliador', rotulo: 'Avaliador', filtro: 'lista', quebra: true },
